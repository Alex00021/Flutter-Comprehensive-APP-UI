...
class MakeUpsDetailPage extends StatefulWidget {
  /// 设置序列ID
  final String id;
  ...
  const MakeUpsDetailPage(
      {Key? key,
        required this.id,
        required this.name,
        required this.code,
        required this.makeupsImg,
        required this.price,
      ...
      : super(key: key);
  @override
  _MakeUpsDetailPageState createState() => _MakeUpsDetailPageState();
}

class _MakeUpsDetailPageState extends State<MakeUpsDetailPage> {
  int activeSize = 0;
  String activeImg = "";
  /// 选择数量
  int num = 1;
